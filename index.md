...
_软件工程师_<br>
1. 客户方案落地设计。
2. 前端开发、后端开发、单元测试、数据库开发。


_项目经历_
1. EDSP_ `上海, 2020.5 - 2020.12`<br>
1.技术栈：前端Angular、后端Springboot、数据库PostgreSQL、服务器AWS。<br>
2.连携BA制定软件设计方案，并撰写前端开发设计书、后端开发设计书、API设计书撰写。<br>
3.前端页面逻辑层开发、通用组件开发。<br>
4.后端API开发、UT测试开发、API相关数据库开发。
