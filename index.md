...
3.在此项目中负责取消/解约、付款两大功能块的设计及开发。
4.连携BA分析客户需求制定软件设计方案，并撰写前端开发设计书、后端开发设计书、API开发和swagger设计书。<br>
4.取消/解约、付款两大功能块的前端页面逻辑层开发、信用卡支付的通用组件的开发。<br>
5.
